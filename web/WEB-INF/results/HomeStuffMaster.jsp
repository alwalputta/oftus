...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/HomeStuff.css"/>
    ...
    <body>
        ...
        <div class="mainTable">
            ...
            <ul id="middle-column-sortable">
                ...
                <li>
                    <div class="middle-column-element" id="c1">
                        <div class="middle-column-element-heading">
                            COLUMN 2222c2
                        </div>
                        <ul id="middle-row-sortable" class="connectedSortable"> 
                            <li>
                                <div class ="middle-row-element" id="c2r2">
                                    <img class="favicon" src="images/favicon.ico"/>
                                    <div class="middle-row-element-text" >alwal reddy putta1212</div> 
                                </div>
                            </li>
                            ...
                            <li>
                                <div class ="middle-row-element" id="c2r2">
                                    <img class="favicon" src="images/favicon.ico"/>
                                    <div class="middle-row-element-text" >alwal reddy putta</div> 
                                </div>
                            </li>
                            <li>
                                <div class ="middle-row-element" id="c2r3">
                                    <img class="favicon" src="images/favicon.ico"/>
                                    <div class="middle-row-element-text" >alwal reddy putta</div> 
                                </div>
                            </li>
                            <li>
                                <div class ="middle-row-element" id="c2r4">
                                    <img class="favicon" src="images/favicon.ico"/>
                                    <div class="middle-row-element-text" >alwal reddy putta</div> 
                                </div>
                            </li>
                ...
                <li>
                    <div class="middle-column-element" id="c2">
                        <div class="middle-column-element-heading">
                            COLUMN 2222c2
                        </div>
                        <ul id="middle-row-sortable" class="connectedSortable"> 
                            <li><div class ="middle-row-element" id="c1r1">
                                    <img class="favicon" src="images/favicon.ico"/>
                                    <div class="middle-row-element-text">Braddock And Logan Homes</div>
                                </div>
                            </li>

                            <li><div class ="middle-row-element" id="c2r2">
                                    <img class="favicon" src="images/favicon.ico"/>
                                    <div class="middle-row-element-text" >alwal reddy putta</div> 
                                </div>
                            </li>
                            <li><div class ="middle-row-element" id="c2r3">
                                    <img class="favicon" src="images/favicon.ico"/>
                                    <div class="middle-row-element-text" >alwal reddy putta</div> 
                                </div>
                            </li>
                            <li><div class ="middle-row-element" id="c2r4">
                                    <img class="favicon" src="images/favicon.ico"/>
                                    <div class="middle-row-element-text" >alwal reddy putta</div> 
                                </div>
                            </li>
        ...
        <script type="text/javascript" src="js/HomeStuff.js"></script>
